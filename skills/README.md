...
Executa o fluxo completo para uma issue do Redmine: busca via MCP, valida o contexto, analisa a codebase, coleta interativamente informações do desenvolvedor em 3 portões obrigatórios, gera planos de implementação + testes, implementa e atualiza o status.

**Como usar:**
> redmine: #168856 — implemente esta issue do Redmine.

---

### relatorio-desenvolvedor

Gera relatórios de atividade de desenvolvedores a partir de lançamentos de horas no Redmine, organizados por colaboradores, projetos e tipos de atividade. Salva os resultados como arquivo Markdown na pasta relatorios/ com KPIs para o período especificado.

**Como usar:**
> relatório desenvolvedor — horas lançadas em março/2026.
