...
O processo de contagem de Pontos de Função é detalhado e segue regras estritas estabelecidas por organizações como o **IFPUG** (_International Function Point Users Group_). Ele se baseia na identificação e classificação dos **Requisitos Funcionais do Usuário** em cinco tipos principais de funções.
...
O peso atribuído a cada função (em Pontos de Função) é definido conforme a metodologia do **IFPUG** (_International Function Point Users Group_):
...
| :--------------------------------------------- | :------------------------------------------------------------- |
| **DERs** (_Data Element Types_)                | Número de campos (atributos) únicos reconhecidos pelo usuário. |
| **RLRs/ALRs** (_Record/File Types Referenced_) | Número de relacionamentos ou arquivos referenciados.           |
...
**Resultado:** A **melhoria/atualização** da funcionalidade de Alteração de Cliente é estimada em **3 Pontos de Função Não-Ajustados** (EFP - _Enhancement Function Points_), refletindo apenas o esforço de mudança.
