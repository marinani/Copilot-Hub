...
description: 'Deep investigation and documentation of an existing codebase or workspace. Use when asked to "understand the system", "map the codebase", "document how this app works", "reverse engineer the flow", "investigate before refactoring", or "explain this project in detail". Produces a rich, structured knowledge artifact covering architecture, data flows, validations, frontend, backend, integrations, and design patterns — detailed enough to fully reproduce the system from scratch.'
---
