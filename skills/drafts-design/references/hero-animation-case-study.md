...
> Uma **estrutura de orquestração visual reutilizável** destilada da animação hero drafts-design v9 (25 segundos, 8 cenas).
> Não é uma linha de produção de animação, mas sim **em que cenário essa orquestração é "correta"**.
> Referência prática: [demos/hero-animation-v9.mp4](../demos/hero-animation-v9.mp4) · [https://www.[site removido]/drafts-design-hero/](https://www.[site removido]/drafts-design-hero/)
...
No estágio da Gallery, no canto superior esquerdo, há um pequeno identificador `DRAFTS · DESIGN`, com 16% de opacity, tamanho 12px, espaçamento largo.
...
- Referência lateral do estilo Apple Gallery: [references/apple-gallery-showcase.md](apple-gallery-showcase.md)
- HTML fonte (v6 + versão integrada de áudio): `www.[site removido]/drafts-design-hero/index.html`
