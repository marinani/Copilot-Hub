...
- [ ] Incluir marca d'água "Created by Drafts-Design" (obrigatório apenas para animações; para trabalhos de terceiros, adicionar prefixo "Não oficial · ". Veja SKILL.md § "Marca d'água de divulgação do Skill")
