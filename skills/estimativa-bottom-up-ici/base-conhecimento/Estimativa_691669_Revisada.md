...
|-----------|-------------|--------------|
| Eng. Requisitos (40%) | 6:30 | 18,06% |
| Arquitetura (40%) | 26:30 | 73,61% |
| Implementação (75%) | 3:00 | 8,33% |
| Teste (20%) | 0:00 | 0,00% |
| Cientista de Dados (10%) | 36:00 | 100,00% |
