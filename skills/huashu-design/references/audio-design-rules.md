# Regras de Design de Áudio · huashu-design

> Todas as receitas de aplicação de áudio para demos de animação. Use em conjunto com `sfx-library.md` (inventário de ativos).
> Forjado na prática: iterações hero v1-v9 do lançamento huashu-design · Decomposição aprofundada de três vídeos oficiais da Anthropic · Mais de 8000 comparações A/B
...
O skill huashu-design vem com 6 músicas BGM (`assets/bgm-*.mp3`):
...
### Receita A · Hero de lançamento de produto (mesmo estilo do huashu-design v9)
...
- Análise aprofundada de áudio dos três vídeos da Anthropic: `/Users/alchain/Documents/写作/01-公众号写作/项目/2026.04-huashu-design发布/参考动画/AUDIO-BEST-PRACTICES.md`
- Caso prático huashu-design v9: `/Users/alchain/Documents/写作/01-公众号写作/项目/2026.04-huashu-design发布/配图/hero-animation-v9-final.mp4`
