...
> Destilado de dois cinematic demos do deck "聊聊 skill" de 2026-04 (workflow Nuwa + workflow Darwin), comprovadamente reproduzíveis.
...
**Solução**: use `huashu-gpt-image` para gerar uma imagem grande em grid 4×2 (8 itens relacionados ao tema · fundo branco · 60px de breathing space · estilo unificado), use `extract_grid.py --mode bbox` para recortar em 8 PNGs transparentes independentes.

**Pontos-chave do Prompt** (padrões detalhados de prompt veja a skill `huashu-gpt-image`):
