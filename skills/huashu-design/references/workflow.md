...
**Variações** 4. Quantas variações você quer? Em quais dimensões variar (visual/interação/cores/...)? 5. Prefere que todas estejam "próximas da resposta" ou um mapa do conservador ao ousado?
